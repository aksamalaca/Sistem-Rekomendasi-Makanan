# -*- coding: utf-8 -*-
"""Proyek Akhir Sistem Rekomendasi Makanan_Aksamala Citrayuh Anasita

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Md8MoDCcXf59r8OahVD6YKpXSIDGvvPu
...
Output menampilkan 10 rekomendasi makanan terbaik untuk user dengan ID 97 berdasarkan prediksi model. Daftar ini berisi nama makanan, kategori (C\_Type), dan status vegetarian (veg) atau non-vegetarian (non-veg). Rekomendasi mencakup variasi hidangan dari berbagai kategori seperti Healthy Food, Indian, Snack, French, Italian, dan Dessert.
...
Output menunjukkan hasil evaluasi model rekomendasi menggunakan Mean Squared Error (MSE) dan Root Mean Squared Error (RMSE). Nilai MSE sekitar 0.2843017512004052 dan RMSE sekitar 0.5331995416355918 menandakan rata-rata kesalahan prediksi rating model terhadap rating aktual user tersebut. Nilai RMSE sebesar 0.5331995416355918 menunjukkan prediksi model memiliki deviasi sedang dari nilai rating sebenarnya pada skala normalisasi rating.
"""