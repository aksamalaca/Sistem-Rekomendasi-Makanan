# -*- coding: utf-8 -*-
"""Proyek_Akhir_Sistem_Rekomendasi_Makanan_Aksamala_Citrayuh_Anasita (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ddnClYZ1bpGD7i_BLhz0k8YtFrYGVjjb
...
Output menunjukkan hasil evaluasi model rekomendasi menggunakan Mean Squared Error (MSE) dan Root Mean Squared Error (RMSE). Nilai MSE sekitar 0.5049158441478518 dan RMSE sekitar 0.7105743058595996 menandakan rata-rata kesalahan prediksi rating model terhadap rating aktual user tersebut. Nilai RMSE sebesar 0.7105743058595996 menunjukkan prediksi model memiliki deviasi sedang dari nilai rating sebenarnya pada skala normalisasi rating.
"""